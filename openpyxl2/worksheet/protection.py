...
from openpyxl2.descriptors import Strict, Bool, String, Alias
...
class SheetProtection(Strict):
    ...
    def __init__(self, sheet=False, objects=False, scenarios=False,
                 ...
                 password=None, algorithmName=None):
        self.sheet = sheet
        ...
        if password is not None:
            self.set_password(password, True)
    ...
    def __iter__(self):
        for key in ('sheet', 'objects', 'scenarios', 'formatCells',
                  ...
                  'pivotTables', 'password', 'algorithmName'):
