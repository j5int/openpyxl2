...
def test_to_excel_mac(value, expected):
    from openpyxl2.utils.datetime import to_excel, CALENDAR_MAC_1904
    FUT = to_excel
...
def test_from_excel_mac(value, expected):
    from openpyxl2.utils.datetime import from_excel, CALENDAR_MAC_1904
    FUT = from_excel
    assert FUT(value, CALENDAR_MAC_1904) == expected


def test_time_to_days():
    from openpyxl2.utils.datetime  import time_to_days
    FUT = time_to_days
    t1 = time(13, 55, 12, 36)
...
def test_timedelta_to_days():
    from openpyxl2.utils.datetime import timedelta_to_days
...
def test_days_to_time():
    from openpyxl2.utils.datetime import days_to_time
