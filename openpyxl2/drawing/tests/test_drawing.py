...
from openpyxl2.xml.constants import CHART_DRAWING_NS, SHEET_DRAWING_NS
...
class TestShape(object):
    ...
    def setup(self):
        from openpyxl2.drawing import Shape
...
class TestShadow(object):
    ...
    def setup(self):
        from openpyxl2.drawing import Shadow
        self.shadow = Shadow()
...
class TestDrawingWriter(object):
    ...
    def setup(self):
        from openpyxl2.writer.drawings import DrawingWriter
        sheet = DummySheet()
        sheet._charts = []
        sheet._images = []
...
class TestShapeWriter(object):
    ...
    def setup(self):
        from openpyxl2.writer.drawings import ShapeWriter
        from openpyxl2.drawing import Shape
        chart = DummyChart()
