...
def Chart():
    """Chart class"""
    from openpyxl2.charts.chart import Chart
    return Chart
...
def GraphChart():
    """GraphicChart class"""
    from openpyxl2.charts.graph import GraphChart
    return GraphChart
...
def Axis():
    """Axis class"""
    from openpyxl2.charts.axis import Axis
    return Axis
...
def PieChart():
    """PieChart class"""
    from openpyxl2.charts import PieChart
    return PieChart
...
def LineChart():
    """LineChart class"""
    from openpyxl2.charts import LineChart
    return LineChart
...
def BarChart():
    """BarChart class"""
    from openpyxl2.charts import BarChart
    return BarChart
...
def ScatterChart():
    """ScatterChart class"""
    from openpyxl2.charts import ScatterChart
    return ScatterChart
...
def Reference():
    """Reference class"""
    from openpyxl2.charts import Reference
    return Reference
...
def Series():
    """Serie class"""
    from openpyxl2.charts import Series
    return Series
...
def ErrorBar():
    """ErrorBar class"""
    from openpyxl2.charts import ErrorBar
    return ErrorBar
